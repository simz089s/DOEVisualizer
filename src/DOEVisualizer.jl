...
# using DOEVisualizerCore
# include("DOEVisualizerDBManager.jl")
include("DOEVisualizerCore.jl")
...
function on_load_button_clicked(w, CONFIG_NEW, xlsrange, xlssheet)
    ...
    DOEVisualizerCore.setup(df, titles, vars, resps, num_vars, num_resps, filename_save, cm, CONFIG, LOCALE_TR)
end
